...
function createCategoryCard(category) {
    ...
    col.innerHTML = `
        <div class="hover-effect-scale">
            <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="shop-catalog-electronics.php?category=${category.slug}">
            ...
            <h2 class="h6 d-flex w-100 pb-2 mb-1">
                <a class="animate-underline animate-target d-inline text-truncate" 
                   href="shop-catalog-electronics.php?category=${category.slug}">
                    ${category.name}
                </a>
            </h2>
