...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <!-- SEO Meta Tags -->
    <title>Cartzilla | Privacy Policy</title>
      ...
      <div class="container py-5 mb-2 mt-n2 mt-sm-1 my-md-3 my-lg-4 mb-xl-5">
        <div class="row justify-content-center">
          <div class="col-lg-11 col-xl-10 col-xxl-9">
            ...
            <p class="pt-2 pt-lg-3">In order for the website to provide a safe and useful service, it is important for <a href="http://atsmore.com/" target="_blank">http://atsmore.com/</a> to collect, use, and share personal information.</p>

            <h2 class="h4 pt-3 pt-lg-4">Collection</h2>
            ...
            <h2 class="h4 pt-3 pt-lg-4">Use</h2>
            ...
            <h2 class="h4 pt-3 pt-lg-4">Disclosure</h2>
            ...
            <h2 class="h4 pt-3 pt-lg-4">Communication and email tools</h2>
            ...
            <h2 class="h4 pt-3 pt-lg-4">Security</h2>
